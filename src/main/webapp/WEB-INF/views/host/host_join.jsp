...
<body>
<form id="joinForm"  action="${pageContext.request.contextPath }/join/host" class="form" method="post">
	<h3 class="mb-5" style="text-align: center; font-size: 10px; font-weight:900; color: #706FFF;">호스트 회원가입</h3>
	<label for="id">
		<p>아이디</p>
		<input class="join" type="text" id="id" name="hId">
	</label>
	<div class="mb-5">
	...
	<label for="password">
		<p>비밀번호</p>	
		<input class="join" type="password" id="passwd" name="hPw" required>
	</label>
	<div class="mb-5">
	...
	<label for="name">
		<p>이름</p>	
		<input class="join" type="text" id="name" name="hName" required>
	</label>
	<div class="mb-5">
	...
	<label for="email">
		<p>이메일</p>	
		<input class="join" type="email" id="email" name="hEmail">
	</label>
	<div class="mb-5">
	...
	<label for="phone">
		<p>휴대폰 번호</p>	
		<input class="join" type="text" id="phone" name="hPhone" required>
	</label>
	<div class="mb-5">
	...
	<div style="color: red;">회원가입 시에 아래의 양식은 필수는 아니며, </div>
	<div style="color: red;" class="mb-5">사후 마이페이지에서 기입 가능합니다.</div>	
	<label for="CeoName">
		<p>상호명</p>	
		<input class="join" type="text" name="hSpacename">
	</label>
	<label for="CeoName">
		<p>대표자명</p>	
		<input class="join" type="text" name="hCeoname">
	</label>
	<label for="CeoName">
		<p>사업자 등록 번호</p>	
		<input class="join" type="text" name="hNum">
	</label>
	<label for="CeoName">
		<p>계좌번호</p>	
		<input class="join" type="text" name="hAccount">
	</label>
	<label for="CeoName">
		<p>은행명</p>	
		<input class="join" type="text" name="hBank">
	</label>
	<label for="CeoName">
		<p>예금주</p>	
		<input class="join" type="text" name="hAccountname">
	</label>
